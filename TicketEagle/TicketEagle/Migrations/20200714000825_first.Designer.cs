...
namespace TicketEagle.Migrations
{
    ...
    [Migration("20200714000825_first")]
    partial class first
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketEagle.Areas.Identity.Data.TicketEagleUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TicketEagle.Models.Bilhete", b =>
                {
                    ...
                    b.Property<int>("EventoFK2")
                        .HasColumnType("int");

                    b.Property<decimal>("Preco")
                        .HasColumnType("decimal(10,2)");

                    b.Property<int?>("UtilizadorUserID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EventoFK2");

                    b.HasIndex("UtilizadorUserID");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TicketEagle.Areas.Identity.Data.TicketEagleUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TicketEagle.Models.Bilhete", b =>
                {
                    b.HasOne("TicketEagle.Models.Evento", "EvId")
                        .WithMany()
                        .HasForeignKey("EventoFK2")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TicketEagle.Models.Utilizador", null)
                        .WithMany("ListaBilhetes")
                        .HasForeignKey("UtilizadorUserID");
                });
