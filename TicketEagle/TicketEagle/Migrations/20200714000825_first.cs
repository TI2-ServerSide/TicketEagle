    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Evento", x => x.EvId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventoFK2 = table.Column<int>(nullable: false),
                    Preco = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    UtilizadorUserID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bilhete", x => x.TicketID);
                    table.ForeignKey(
                        name: "FK_Bilhete_Evento_EventoFK2",
                        column: x => x.EventoFK2,
                        principalTable: "Evento",
                        principalColumn: "EvId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bilhete_Utilizador_UtilizadorUserID",
                        column: x => x.UtilizadorUserID,
